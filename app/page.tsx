    ...
    <main>
      ...
      <section className="section shell about-grid" id="about">
        ...
        <div className="about-copy">
          ...
          <dl><div><dt>Current questions</dt><dd>Interfacial stability · Ion transport · Computation-guided experiments</dd></div><div><dt>Methods</dt><dd>DFT · Machine learning · FEM · Solid-state synthesis · Electrochemical characterizations</dd></div><div><dt>Current position</dt><dd>Research Officer and Researcher · Agency for Defense Development</dd></div><div><dt>Seeking</dt><dd>Ph.D. opportunities · Fall 2027</dd></div></dl>
        </div>
      </section>
