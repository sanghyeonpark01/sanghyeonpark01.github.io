...
export const publications: Publication[] = [
  {
    ...
    detailImages: [
      { src: "/publications/details/jmca-p4.jpg", alt: "Figure 1 showing the cathode–coating database and machine-learning research workflow" },
      { src: "/publications/details/jmca-p6.jpg", alt: "Figure 2 showing cathode and metal-oxide coating reaction-energy heatmaps" },
    ],
  ...
  },
  {
    ...
    detailImages: [
      { src: "/publications/details/jmrt-p3.jpg", alt: "Gas gun setup, projectile model, multilayer battery stack, and compression response" },
      { src: "/publications/details/jmrt-p5.jpg", alt: "Simulated projectile impact response and experimental validation plots" },
    ],
  ...
  },
  {
    ...
    detailImages: [
      { src: "/publications/details/acs-p3.jpg", alt: "Crystal models and structural trends for transition-metal-substituted lithium iron fluoride" },
      { src: "/publications/details/acs-p5.jpg", alt: "Projected density-of-states results for substituted lithium iron fluoride cathodes" },
    ],
  ...
  },
  {
    ...
    detailImages: [
      { src: "/publications/details/rsc-p4.jpg", alt: "XRD, impedance, and Arrhenius analysis of tantalum- and gallium-doped LLZO" },
      { src: "/publications/details/rsc-p5.jpg", alt: "High-temperature discharge performance and internal-resistance comparison of doped LLZO cells" },
    ],
...
export const preprints: Publication[] = [
  {
    ...
    detailImages: [
      { src: "/publications/details/mg-p9.jpg", alt: "Electrochemical stability windows and decomposition energies of magnesium solid electrolytes" },
      { src: "/publications/details/mg-p12.jpg", alt: "High-throughput funnel for screening magnesium-interface coating materials" },
    ],
  ...
  },
  {
    ...
    detailImages: [
      { src: "/publications/details/amx-p30.jpg", alt: "Reaction-energy heatmaps for lithium, sodium, and potassium solid-state battery interfaces" },
      { src: "/publications/details/amx-p31.jpg", alt: "Descriptor-guided coating selection, database construction, and machine-learning workflow" },
    ],
  ...
  },
  {
    ...
    detailImages: [
      { src: "/publications/details/yu-p35.jpg", alt: "Reaction-controlled fluorination scheme for forming iron fluoride surface layers on iron disulfide" },
      { src: "/publications/details/yu-p38.jpg", alt: "Electron microscopy and elemental maps of the fluorinated iron disulfide surface layer" },
    ],
  ...
  },
  {
    ...
    detailImages: [
      { src: "/publications/details/lim-p9.jpg", alt: "LLZTO processing concept, microscopy, impedance, and Arrhenius analysis" },
      { src: "/publications/details/lim-p12.jpg", alt: "High-temperature discharge performance and resistance analysis of LLZTO thermal batteries" },
    ],
